...
public sealed class KustoRecordedSessionArchiveService : IKustoRecordedSessionArchiveService
{
    ...
    private const int MaximumRecordedQueryBytes = 256 * 1024;
    private const int MaximumRecordedRowsPerExecution = 500;
    private const long MaximumSessionEntryBytes = MaximumArchiveBytes;
    private readonly IKustoRecordedSessionArchiveStore store;
    ...
    public KustoRecordedSessionArchiveService(
        IKustoRecordedSessionArchiveStore store,
